...
//هذا القسم هو الأساسي لتفعيل HTTP/2 بطريقة آمنة وسريعة
export const http2Options = {
  ...
  settings: {
    // Disable CONNECT protocol (we don't need it) بمنع أي عميل من استخدام السيرفر كوسيط نقل بيانات (Proxy Tunnel
...
export const sseConfig = {
  ...
  // Heartbeat for SSE connections (milliseconds) أنا لسه عايش 👋، الاتصال لسه مفتوح، لا تسكّره!"
